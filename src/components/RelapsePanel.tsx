...
export function RelapsePanel({
  ...
  if (step === "done") {
    return (
      <div className="modal-overlay modal-overlay--sheet" role="dialog" aria-modal="true" aria-labelledby="relapse-done-title">
        <div className="modal-panel modal-panel--sheet modal-panel--relapse glass-card">
  ...
  return (
    <div className="modal-overlay modal-overlay--sheet" role="dialog" aria-modal="true" aria-labelledby="relapse-title">
      <div className="modal-panel modal-panel--sheet modal-panel--relapse glass-card">
        <div className="modal-panel__header">
        ...
        >
          <div className="modal-panel__body">
            ...
            <label className="relapse-note-field">
              {t("relapse.noteLabel")}
              <textarea
          ...
          <div className="modal-panel__footer relapse-actions">
